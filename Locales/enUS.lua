...
L["Season Max"] = true
L["The seasonal cap on this crest. For some crests it limits how many you can earn all season. For others it limits how many you can hold at once, and spending frees room again."] = true
...
L["While inside a delve, tracks the Nemesis Strongbox packs so you know you've cleared them all before pulling the boss."] = true
...
L["Restore the options to their default values. Your saved runs and the number of runs kept per delve are left alone."] = true
...
L["Bonus Spoils: the Nemesis Strongbox packs to clear before the boss."] = true
