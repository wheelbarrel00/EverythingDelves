...
E:RegisterModule(function()
    ...
    title:SetText(E.CC.header .. "Delve History" .. E.CC.close)
    ...
    headerDiv:SetColorTexture(dc.r, dc.g, dc.b, dc.a)
    ...
    midnightHeader:SetText(E.CC.header .. "Midnight Delves" .. E.CC.close)
