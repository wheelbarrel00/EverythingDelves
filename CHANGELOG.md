...
- **TOC bump for Patch 12.0.7** — Updated `## Interface` to `120001, 120005, 120007` so the addon is flagged compatible with today's 12.0.7 client release and no longer shows as out-of-date.
